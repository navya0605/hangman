...
import pygame
import random
from medium import country_medium
...
background_image = pygame.image.load('static/img/world.png')
...
def run_game():
    ...
    available_words = list(country_medium.keys())
    ...
    while available_words:
        ...
        image_filename = country_medium[word]
