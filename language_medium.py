...
import pygame
import random
from medium import language_medium
...
# Timer setting
TIME_LIMIT = 3 * 60 * 1000  # 2 minutes in milliseconds

# Load and scale the background image
background_image = pygame.image.load('static/img/languages.png')
...
def run_game():
    ...
    available_words = list(language_medium.keys())
    ...
    while available_words:
        ...
        image_filename = language_medium[word]
