...
import pygame
import random
from medium import flowers_medium
...
background_image = pygame.image.load('static/img/flowers.png')
...
def run_game():
    ...
    available_words = list(flowers_medium.keys())
    ...
    while available_words:
        ...
        image_filename = flowers_medium[word]
