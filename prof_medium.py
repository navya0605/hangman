...
import pygame
import random
from medium import prof_medium
...
background_image = pygame.image.load('static/img/prof.png')
...
def run_game():
    ...
    available_words = list(prof_medium.keys())
    ...
    while available_words:
        ...
        image_filename = prof_medium[word]
